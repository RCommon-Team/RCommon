...
/// table atomically with the business row; the outbox poller relays it to the MassTransit producer
...
public class Worker : BackgroundService
{
    ...
    {
        Console.WriteLine("Recipe 2a (MassTransit) example starting");
