...
namespace Samples.Application.Contracts.Dto
{
    ...
    {
        public DiveLocationListModel(IPaginatedList<DiveLocation> diveLocations, PaginatedListRequest paginatedListRequest):base(diveLocations, paginatedListRequest)
        {
