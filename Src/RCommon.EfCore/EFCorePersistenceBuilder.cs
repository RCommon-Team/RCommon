...
namespace RCommon
{
    ...
    /// </remarks>
    public class EFCorePersistenceBuilder : IEFCorePersistenceBuilder
    {
        private readonly IServiceCollection _services;

        /// <summary>
        /// Initializes a new instance of <see cref="EFCorePersistenceBuilder"/> and registers
        ...
        public EFCorePersistenceBuilder(IServiceCollection services)
        {
