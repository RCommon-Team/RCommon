...
{
    private List<ValidationFault> _errors;
    ...
    /// </summary>
    public List<ValidationFault> Errors
    {
        get => _errors;
        set
        {
    ...
    {
        _errors = new List<ValidationFault>();
    }

    /// <summary>
    /// Creates a new ValidationResult from a collection of failures
    /// </summary>
    /// <param name="failures">Collection of <see cref="ValidationFault"/> instances which is later available through the <see cref="Errors"/> property.</param>
    /// <remarks>
    /// Any nulls will be excluded.
    /// The list is copied.
    /// </remarks>
    public ValidationOutcome(IEnumerable<ValidationFault> failures)
    {
