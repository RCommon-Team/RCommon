...
namespace RCommon.Persistence.Caching.MemoryCache
{
    ...
    {
        public static IPersistenceCachingBuilder AddPersistenceCaching(this IPersistenceCachingBuilder builder, Func<IServiceProvider, Func<PersistenceCachingStrategy, ICacheService>> cacheFactory)
        {
