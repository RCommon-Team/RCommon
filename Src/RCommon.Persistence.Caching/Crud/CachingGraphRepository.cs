...
{
    /// <summary>
    /// Decorator around <see cref="IGraphRepository{TEntity}"/> that adds cache-aware query overloads.
        ...
        where TEntity : class, IBusinessEntity
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CachingGraphRepository{TEntity}"/> class.
        /// </summary>
