...
namespace RCommon.ObjectAccess.EFCore
{
        ...
        where TContext : RCommonDbContext
    {
        ...
        public DataStoreDbContextOptionsBuilder()
            : this(new DataStoreDbContextOptions<TContext>())
        {
        }

        /// <summary>
        ///     Initializes a new instance of the <see cref="DataStoreDbContextOptionsBuilder{TContext}" /> class to further configure
        ///     a given <see cref="DbContextOptions" />.
        /// </summary>
        /// <param name="options"> The options to be configured. </param>
        public DataStoreDbContextOptionsBuilder([NotNull] DataStoreDbContextOptions<TContext> options)
            : base(options)
        {
        }
        ...
        /// </summary>
        public new virtual DataStoreDbContextOptions<TContext> Options => (DataStoreDbContextOptions<TContext>)base.Options;
        ...
        public new virtual DataStoreDbContextOptionsBuilder<TContext> UseLoggerFactory([CanBeNull] ILoggerFactory loggerFactory)
            => (DataStoreDbContextOptionsBuilder<TContext>)base.UseLoggerFactory(loggerFactory);
        ...
        /// </summary>
        /// <returns> The same builder instance so that multiple calls can be chained. </returns>
        public new virtual DataStoreDbContextOptionsBuilder<TContext> EnableDetailedErrors(bool detailedErrorsEnabled = true)
            => (DataStoreDbContextOptionsBuilder<TContext>)base.EnableDetailedErrors(detailedErrorsEnabled);
        ...
        /// <returns> The same builder instance so that multiple calls can be chained. </returns>
        public new virtual DataStoreDbContextOptionsBuilder<TContext> UseMemoryCache([CanBeNull] IMemoryCache memoryCache)
            => (DataStoreDbContextOptionsBuilder<TContext>)base.UseMemoryCache(memoryCache);
        ...
        /// <returns> The same builder instance so that multiple calls can be chained. </returns>
        public new virtual DataStoreDbContextOptionsBuilder<TContext> UseInternalServiceProvider([CanBeNull] IServiceProvider serviceProvider)
            => (DataStoreDbContextOptionsBuilder<TContext>)base.UseInternalServiceProvider(serviceProvider);
        ...
        /// <param name="serviceProvider"> The service provider to be used. </param>
        /// <returns> The same builder instance so that multiple calls can be chained. </returns>
        public new virtual DataStoreDbContextOptionsBuilder<TContext> UseApplicationServiceProvider([CanBeNull] IServiceProvider serviceProvider)
            => (DataStoreDbContextOptionsBuilder<TContext>)base.UseApplicationServiceProvider(serviceProvider);
        ...
        /// </summary>
        /// <returns> The same builder instance so that multiple calls can be chained. </returns>
        public new virtual DataStoreDbContextOptionsBuilder<TContext> EnableSensitiveDataLogging(bool sensitiveDataLoggingEnabled = true)
            => (DataStoreDbContextOptionsBuilder<TContext>)base.EnableSensitiveDataLogging(sensitiveDataLoggingEnabled);
        ...
        /// <returns> The same builder instance so that multiple calls can be chained. </returns>
        public new virtual DataStoreDbContextOptionsBuilder<TContext> EnableServiceProviderCaching(bool cacheServiceProvider = true)
            => (DataStoreDbContextOptionsBuilder<TContext>)base.EnableServiceProviderCaching(cacheServiceProvider);
        ...
        ///     </para>
        /// </summary>
        public new virtual DataStoreDbContextOptionsBuilder<TContext> UseQueryTrackingBehavior(QueryTrackingBehavior queryTrackingBehavior)
            => (DataStoreDbContextOptionsBuilder<TContext>)base.UseQueryTrackingBehavior(queryTrackingBehavior);
        ...
        /// <returns> The same builder instance so that multiple calls can be chained. </returns>
        public new virtual DataStoreDbContextOptionsBuilder<TContext> ReplaceService<TService, TImplementation>()
            where TImplementation : TService
            => (DataStoreDbContextOptionsBuilder<TContext>)base.ReplaceService<TService, TImplementation>();
    }
}