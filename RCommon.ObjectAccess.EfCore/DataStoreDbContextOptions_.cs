...
namespace RCommon.ObjectAccess.EFCore
{
    ...
    /// </summary>
    public abstract class DataStoreDbContextOptions : IDbContextOptions
    {
        /// <summary>
        ...
        protected DataStoreDbContextOptions(
            [NotNull] IReadOnlyDictionary<Type, IDbContextOptionsExtension> extensions)
        {
            Guard.IsNotNull(extensions, nameof(extensions));
        ...
        public abstract DataStoreDbContextOptions WithExtension<TExtension>([NotNull] TExtension extension)
            where TExtension : class, IDbContextOptionsExtension;
        ...
        ///     configured with <see cref="DbContext.OnConfiguring(DataStoreDbContextOptionsBuilder)" />.
        /// </summary>
