...
namespace RCommon.ObjectAccess.EFCore
{
    ...
    {
        EFObjectSourceLifetimeManager _resolver;

        public EFUnitOfWorkFactory(EFObjectSourceLifetimeManager objectSourceLifetimeManager)
        {
            _resolver = objectSourceLifetimeManager;
        }
        ...
        public void RegisterObjectSource(Func<DbContext> contextProvider)
        {
            ...
            _resolver.RegisterObjectSource(contextProvider);
        }
