...
- `WithPersistence<EFCorePerisistenceBuilder>` runs twice; the same persistence sub-builder is reused and `AddDbContext` accumulates both `"Ordering"` and `"Inventory"` data stores.
