...
This page documents the contract. For the underlying builder API itself, see [Fluent Configuration](./fluent-configuration.md).
...
- [Fluent Configuration](./fluent-configuration.md) — the underlying builder API.
- [GUID Generation](./guid-generation.md) — singleton-style verb that participates in the conflict matrix.
- [System Time](./system-time.md) — same.
