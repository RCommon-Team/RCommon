...
- **Fluent, DI-first configuration** — a single `AddRCommon()` call bootstraps everything through a composable builder chain. RCommon supports both single-call and multi-module composition; see [Modular Composition](../core-concepts/modular-composition.md).
