...
builder.Services.AddRCommon()
    ...
    {
        local.AddSubscriber<AuditEvent, AuditEventHandler>();   // in-process; auto-registers the producer
    })
    .WithEventHandling<MassTransitEventHandlingBuilder>(mt =>
    {
        mt.Publish<OrderShipped>();                             // outbound fan-out; auto-registers the producer
