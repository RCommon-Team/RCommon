...
sidebar_position: 4
description: Guarantee at-least-once event delivery using the transactional outbox pattern with MassTransit EF Core outbox or Wolverine's EF Core transaction integration.
---
...
There are two supported strategies, both fully documented with diagrams in the [Event Handling Recipes](./recipes.mdx) guide:
...
- [Event Handling Recipes](./recipes.mdx) — full wiring and diagrams for Recipe 2a and Recipe 2b.
