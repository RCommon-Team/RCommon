...
/* harmony import */ var lodash_es_clone_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(24024);
/* harmony import */ var khroma__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(30941);
/* harmony import */ var khroma__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(80124);
/* harmony import */ var _edges_96097737_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(48579);
/* harmony import */ var dagre_d3_es_src_graphlib_index_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(34654);
...
let classes = {};
const sanitizeText = (txt) => _mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.e.sanitizeText(txt, config);
  ...
  for (const block of blockList) {
    ...
    if (block.type === "column-setting") {
      ...
      if (block.type === "space") {
        ...
        for (let j = 0; j < w; j++) {
          const newBlock2 = (0,lodash_es_clone_js__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .A)(block);
...
const clear = () => {
  _mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.l.debug("Clear called");
...
function typeStr2Type(typeStr) {
  _mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.l.debug("typeStr2Type", typeStr);
  switch (typeStr) {
    case "[]":
      return "square";
    case "()":
      _mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.l.debug("we have a round");
      return "round";
    case "(())":
      return "circle";
    case ">]":
...
const db = {
  getConfig: () => (0,_mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.F)().block,
  typeStr2Type,
  edgeTypeStr2Type,
  edgeStrToEdgeData,
  getLogger,
...
const fade = (color, opacity) => {
  const channel = khroma__WEBPACK_IMPORTED_MODULE_3__/* ["default"] */ .A;
  const r = channel(color, "r");
  const g = channel(color, "g");
  const b = channel(color, "b");
  return khroma__WEBPACK_IMPORTED_MODULE_2__/* ["default"] */ .A(r, g, b, opacity);
};
...
function getNodeFromBlock(block, db2, positioned = false) {
  ...
  const styles = (0,_mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.k)((vertex == null ? void 0 : vertex.styles) || []);
  ...
  const node = {
    ...
    intersect: void 0,
    type: vertex.type,
    padding: padding2 ?? (((_c = (_b2 = (0,_mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.F)()) == null ? void 0 : _b2.block) == null ? void 0 : _c.padding) || 0)
  };
  return node;
}
async function calculateBlockSize(elem, block, db2) {
  ...
  const nodeEl = await (0,_edges_96097737_js__WEBPACK_IMPORTED_MODULE_4__.e)(elem, node);
...
async function insertBlockPositioned(elem, block, db2) {
  ...
  const obj = db2.getBlock(node.id);
  if (obj.type !== "space") {
    await (0,_edges_96097737_js__WEBPACK_IMPORTED_MODULE_4__.e)(elem, node);
    block.intersect = node == null ? void 0 : node.intersect;
    (0,_edges_96097737_js__WEBPACK_IMPORTED_MODULE_4__.p)(node);
  }
}
  ...
  for (const edge of edges) {
    if (edge.start && edge.end) {
      ...
      if ((startBlock == null ? void 0 : startBlock.size) && (endBlock == null ? void 0 : endBlock.size)) {
        ...
        await (0,_edges_96097737_js__WEBPACK_IMPORTED_MODULE_4__.h)(
          elem,
        ...
        if (edge.label) {
          await (0,_edges_96097737_js__WEBPACK_IMPORTED_MODULE_4__.f)(elem, {
            ...edge,
            label: edge.label,
          ...
          await (0,_edges_96097737_js__WEBPACK_IMPORTED_MODULE_4__.j)(
...
const padding = ((_b = (_a = (0,_mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.c)()) == null ? void 0 : _a.block) == null ? void 0 : _b.padding) || 8;
...
function setBlockSizes(block, db2, siblingWidth = 0, siblingHeight = 0) {
  ...
  if (((_c = block.children) == null ? void 0 : _c.length) > 0) {
    ...
    _mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.l.debug("setBlockSizes abc95 maxWidth of", block.id, ":s children is ", maxWidth, maxHeight);
    for (const child of block.children) {
      if (child.size) {
        _mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.l.debug(
    ...
    if (width < siblingWidth) {
      ...
      _mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.l.debug("Size indata abc88", block.id, "childWidth", childWidth, "maxWidth", maxWidth);
      _mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.l.debug("Size indata abc88", block.id, "childHeight", childHeight, "maxHeight", maxHeight);
      _mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.l.debug("Size indata abc88 xSize", xSize, "padding", padding);
      for (const child of block.children) {
        if (child.size) {
    ...
    if (width < (((_e = block == null ? void 0 : block.size) == null ? void 0 : _e.width) || 0)) {
      ...
      if (num > 0) {
        ...
        _mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.l.debug("abc95 (growing to fit) width", block.id, width, (_g = block.size) == null ? void 0 : _g.width, childWidth);
        for (const child of block.children) {
          if (child.size) {
            child.size.width = childWidth;
          }
...
function layoutBlocks(block, db2) {
  ...
  const columns = block.columns || -1;
  _mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.l.debug("layoutBlocks columns abc95", block.id, "=>", columns, block);
  ...
  block.children.length > 0) {
    ...
    _mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.l.debug("widthOfChildren 88", widthOfChildren, "posX");
    let columnPos = 0;
    _mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.l.debug("abc91 block?.size?.x", block.id, (_f = block == null ? void 0 : block.size) == null ? void 0 : _f.x);
    ...
    for (const child of block.children) {
      ...
      if (py != rowPos) {
        ...
        _mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.l.debug("New row in layout for block", block.id, " and child ", child.id, rowPos);
      }
      _mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.l.debug(
      ...
      _mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.l.debug("abc88 columnsPos", child, columnPos);
    }
  }
  _mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.l.debug(
...
function layout(db2) {
  ...
  layoutBlocks(root);
  _mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.l.debug("getBlocks", JSON.stringify(root, null, 2));
...
const draw = async function(text, id, _version, diagObj) {
  const { securityLevel, block: conf } = (0,_mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.F)();
  ...
  const svg = securityLevel === "sandbox" ? root.select(`[id="${id}"]`) : (0,d3__WEBPACK_IMPORTED_MODULE_6__/* .select */ .Ltv)(`[id="${id}"]`);
  const markers = ["point", "circle", "cross"];
  (0,_edges_96097737_js__WEBPACK_IMPORTED_MODULE_4__.a)(svg, markers, diagObj.type, id);
  ...
  if (bounds) {
    ...
    (0,_mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.i)(svg, height, width, !!useMaxWidth);
    _mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.l.debug("Here Bounds", bounds, bounds2);
    svg.attr(
      "viewBox",
      `${bounds2.x - 5} ${bounds2.y - 5} ${bounds2.width + 10} ${bounds2.height + 10}`
    );
  }
  (0,d3__WEBPACK_IMPORTED_MODULE_6__/* .scaleOrdinal */ .UMr)(d3__WEBPACK_IMPORTED_MODULE_6__/* .schemeTableau10 */ .zt);
};
const renderer = {
  draw,
  getClasses
