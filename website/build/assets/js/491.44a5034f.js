...
/* harmony export */ });
/* harmony import */ var _styles_b4e223ce_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(86695);
...
/* harmony import */ var _index_5325376f_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(67842);
/* harmony import */ var dayjs__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(44657);
/* harmony import */ var _braintree_sanitize_url__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(48488);
/* harmony import */ var dompurify__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(34644);
/* harmony import */ var dagre_d3_es_src_dagre_index_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(25764);
/* harmony import */ var dagre_d3_es_src_graphlib_json_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(64566);
...
const sanitizeText = (txt) => _mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_3__.e.sanitizeText(txt, (0,_mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_3__.c)());
let conf = {
  dividerMargin: 10,
  padding: 5,
  textHeight: 10,
...
const addNamespaces = function(namespaces, g, _id, diagObj) {
  ...
  _mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_3__.l.info("keys:", keys);
  _mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_3__.l.info(namespaces);
  keys.forEach(function(id) {
    ...
    const node = {
      ...
      padding: ((_a = (0,_mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_3__.c)().flowchart) == null ? void 0 : _a.padding) ?? ((_b = (0,_mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_3__.c)().class) == null ? void 0 : _b.padding)
    };
    g.setNode(vertex.id, node);
    addClasses(vertex.classes, g, _id, diagObj, vertex.id);
    _mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_3__.l.info("setNode", node);
  });
};
const addClasses = function(classes, g, _id, diagObj, parent) {
  const keys = Object.keys(classes);
  _mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_3__.l.info("keys:", keys);
  _mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_3__.l.info(classes);
  keys.filter((id) => classes[id].parent == parent).forEach(function(id) {
    var _a, _b;
    const vertex = classes[id];
    const cssClassStr = vertex.cssClasses.join(" ");
    const styles2 = (0,_mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_3__.k)(vertex.styles);
...
const addNotes = function(notes, g, startEdgeId, classes) {
  _mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_3__.l.info(notes);
  notes.forEach(function(note, i) {
    ...
    const edgeData = {
      ...
      style: "fill:none",
      labelStyle: "",
      curve: (0,_mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_3__.n)(conf.curve, d3__WEBPACK_IMPORTED_MODULE_1__/* .curveLinear */ .lUB)
    };
    g.setEdge(vertex.id, vertex.class, edgeData, edgeId);
  });
};
const addRelations = function(relations, g) {
  const conf2 = (0,_mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_3__.c)().flowchart;
  let cnt = 0;
  relations.forEach(function(edge) {
    ...
    const edgeData = {
      ...
      style: "fill:none",
      labelStyle: "",
      curve: (0,_mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_3__.n)(conf2 == null ? void 0 : conf2.curve, d3__WEBPACK_IMPORTED_MODULE_1__/* .curveLinear */ .lUB)
    };
    _mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_3__.l.info(edgeData, edge);
    if (edge.style !== void 0) {
      const styles2 = (0,_mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_3__.k)(edge.style);
    ...
    if (edge.text === void 0) {
      ...
      edgeData.arrowheadStyle = "fill: #333";
      edgeData.labelpos = "c";
      if (((_a = (0,_mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_3__.c)().flowchart) == null ? void 0 : _a.htmlLabels) ?? (0,_mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_3__.c)().htmlLabels) {
        edgeData.labelType = "html";
        edgeData.label = '<span class="edgeLabel">' + edge.text + "</span>";
      } else {
        edgeData.labelType = "text";
        edgeData.label = edge.text.replace(_mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_3__.e.lineBreakRegex, "\n");
        if (edge.style === void 0) {
...
const draw = async function(text, id, _version, diagObj) {
  _mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_3__.l.info("Drawing class - ", id);
  const conf2 = (0,_mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_3__.c)().flowchart ?? (0,_mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_3__.c)().class;
  const securityLevel = (0,_mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_3__.c)().securityLevel;
  _mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_3__.l.info("config:", conf2);
  ...
  _mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_3__.l.info(relations);
  ...
  await (0,_index_5325376f_js__WEBPACK_IMPORTED_MODULE_4__.r)(
    element,
    g,
  ...
  _mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_3__.u.insertTitle(svg, "classTitleText", (conf2 == null ? void 0 : conf2.titleTopMargin) ?? 5, diagObj.db.getDiagramTitle());
  (0,_mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_3__.o)(g, svg, conf2 == null ? void 0 : conf2.diagramPadding, conf2 == null ? void 0 : conf2.useMaxWidth);
...
const diagram = {
  parser: _styles_b4e223ce_js__WEBPACK_IMPORTED_MODULE_0__.p,
  db: _styles_b4e223ce_js__WEBPACK_IMPORTED_MODULE_0__.d,
  renderer,
  styles: _styles_b4e223ce_js__WEBPACK_IMPORTED_MODULE_0__.s,
  init: (cnf) => {
    if (!cnf.class) {
      cnf.class = {};
    }
    cnf.class.arrowMarkerAbsolute = cnf.arrowMarkerAbsolute;
    _styles_b4e223ce_js__WEBPACK_IMPORTED_MODULE_0__.d.clear();
  }
};
