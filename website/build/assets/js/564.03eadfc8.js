...
/* harmony export */ });
/* harmony import */ var _styles_ca3715f6_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(25413);
/* harmony import */ var dagre_d3_es_src_graphlib_index_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(34654);
/* harmony import */ var d3__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(99564);
/* harmony import */ var _mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(70872);
...
const setupNode = (g, parent, parsedItem, diagramStates, diagramDb, altFlag) => {
  ...
  if (itemId !== "root") {
    ...
    if (parsedItem.type !== _styles_ca3715f6_js__WEBPACK_IMPORTED_MODULE_0__.D) {
    ...
    if (!nodeDb[itemId]) {
      nodeDb[itemId] = {
        id: itemId,
        shape,
        description: _mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_3__.e.sanitizeText(itemId, (0,_mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_3__.c)()),
    ...
    if (parsedItem.description) {
      ...
      newNode.description = _mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_3__.e.sanitizeTextOrArray(newNode.description, (0,_mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_3__.c)());
    }
    if (newNode.description.length === 1 && newNode.shape === SHAPE_STATE_WITH_DESC) {
      newNode.shape = SHAPE_STATE;
    }
    if (!newNode.type && parsedItem.doc) {
      _mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_3__.l.info("Setting cluster for ", itemId, getDir(parsedItem));
      newNode.type = "group";
      newNode.dir = getDir(parsedItem);
      newNode.shape = parsedItem.type === _styles_ca3715f6_js__WEBPACK_IMPORTED_MODULE_0__.a ? SHAPE_DIVIDER : SHAPE_GROUP;
  ...
  if (parent && parent.id !== "root") {
    _mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_3__.l.trace("Setting node ", itemId, " to be child of its parent ", parent.id);
    g.setParent(itemId, parent.id);
  }
  if (parsedItem.doc) {
    _mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_3__.l.trace("Adding nodes children ");
    setupDoc(g, parsedItem, parsedItem.doc, diagramStates, diagramDb, !altFlag);
  }
};
const setupDoc = (g, parentParsedItem, doc, diagramStates, diagramDb, altFlag) => {
  _mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_3__.l.trace("items", doc);
  doc.forEach((item) => {
    switch (item.stmt) {
      case _styles_ca3715f6_js__WEBPACK_IMPORTED_MODULE_0__.b:
        setupNode(g, parentParsedItem, item, diagramStates, diagramDb, altFlag);
        break;
      case _styles_ca3715f6_js__WEBPACK_IMPORTED_MODULE_0__.D:
        setupNode(g, parentParsedItem, item, diagramStates, diagramDb, altFlag);
        break;
      case _styles_ca3715f6_js__WEBPACK_IMPORTED_MODULE_0__.S:
        {
          ...
          const edgeData = {
            ...
            style: G_EDGE_STYLE,
            labelStyle: "",
            label: _mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_3__.e.sanitizeText(item.description, (0,_mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_3__.c)()),
            arrowheadStyle: G_EDGE_ARROWHEADSTYLE,
            labelpos: G_EDGE_LABELPOS,
            labelType: G_EDGE_LABELTYPE,
            thickness: G_EDGE_THICKNESS,
...
const getDir = (parsedItem, defaultDir = _styles_ca3715f6_js__WEBPACK_IMPORTED_MODULE_0__.c) => {
  let dir = defaultDir;
  if (parsedItem.doc) {
...
const draw = async function(text, id, _version, diag) {
  _mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_3__.l.info("Drawing state diagram (v2)", id);
  nodeDb = {};
  diag.db.getDirection();
  const { securityLevel, state: conf } = (0,_mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_3__.c)();
  const nodeSpacing = conf.nodeSpacing || 50;
  const rankSpacing = conf.rankSpacing || 50;
  _mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_3__.l.info(diag.db.getRootDocV2());
  ...
  await (0,_index_5325376f_js__WEBPACK_IMPORTED_MODULE_4__.r)(element, g, ["barb"], CSS_DIAGRAM, id);
  const padding = 8;
  _mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_3__.u.insertTitle(svg, "statediagramTitleText", conf.titleTopMargin, diag.db.getDiagramTitle());
  const bounds = svg.node().getBBox();
  const width = bounds.width + padding * 2;
  const height = bounds.height + padding * 2;
  svg.attr("class", CSS_DIAGRAM);
  const svgBounds = svg.node().getBBox();
  (0,_mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_3__.i)(svg, height, width, conf.useMaxWidth);
  const vBox = `${svgBounds.x - padding} ${svgBounds.y - padding} ${width} ${height}`;
  _mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_3__.l.debug(`viewBox ${vBox}`);
...
const diagram = {
  parser: _styles_ca3715f6_js__WEBPACK_IMPORTED_MODULE_0__.p,
  db: _styles_ca3715f6_js__WEBPACK_IMPORTED_MODULE_0__.d,
  renderer,
  styles: _styles_ca3715f6_js__WEBPACK_IMPORTED_MODULE_0__.s,
  init: (cnf) => {
    if (!cnf.state) {
      cnf.state = {};
    }
    cnf.state.arrowMarkerAbsolute = cnf.arrowMarkerAbsolute;
    _styles_ca3715f6_js__WEBPACK_IMPORTED_MODULE_0__.d.clear();
  }
};
