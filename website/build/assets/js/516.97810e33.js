...
const db = {
  getConfig: () => (0,_mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.c)().journey,
  clear,
...
const drawText = function(elem, textData) {
  return (0,_svgDrawCommon_b86b1483_js__WEBPACK_IMPORTED_MODULE_2__.f)(elem, textData);
};
...
const drawBackgroundRect = function(elem, bounds2) {
  (0,_svgDrawCommon_b86b1483_js__WEBPACK_IMPORTED_MODULE_2__.a)(elem, bounds2);
};
...
function drawActorLegend(diagram2) {
  const conf2 = (0,_mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.c)().journey;
  let yPos = 60;
...
const conf = (0,_mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.c)().journey;
...
const draw = function(text, id, version, diagObj) {
  ...
  (0,_mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.i)(diagram2, height, width, conf2.useMaxWidth);
