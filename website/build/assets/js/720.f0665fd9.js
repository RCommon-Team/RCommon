...
/* harmony import */ var dayjs__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(44657);
/* harmony import */ var _braintree_sanitize_url__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(48488);
/* harmony import */ var dompurify__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(34644);
...
const addElement = (name) => {
  if (elements[name] === void 0) {
    ...
    _mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.l.info("Added new requirement: ", name);
  }
  latestElement = {};
...
const db = {
  ...
  VerifyType,
  Relationships,
  getConfig: () => (0,_mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.c)().req,
  addRequirement,
  getRequirements,
  setNewReqId,
  setNewReqText,
...
const drawRelationshipFromLayout = function(svg, rel, g, insert, diagObj) {
  ...
  if (rel.type == diagObj.db.Relationships.CONTAINS) {
    svgPath.attr(
      "marker-start",
      "url(" + _mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.e.getUrl(conf.arrowMarkerAbsolute) + "#" + rel.type + "_line_ending)"
    );
  } else {
    svgPath.attr("stroke-dasharray", "10,7");
    svgPath.attr(
      "marker-end",
      "url(" + _mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.e.getUrl(conf.arrowMarkerAbsolute) + "#" + markers.ReqMarkers.ARROW + "_line_ending)"
    );
  }
...
const drawReqs = (reqs, graph, svgNode) => {
  Object.keys(reqs).forEach((reqName) => {
    ...
    _mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.l.info("Added new requirement: ", reqName);
...
const draw = (text, id, _version, diagObj) => {
  conf = (0,_mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.c)().requirement;
  ...
  (0,_mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.i)(svg, height, width, conf.useMaxWidth);
