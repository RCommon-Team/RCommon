...
/* harmony import */ var _braintree_sanitize_url__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(48488);
/* harmony import */ var _svgDrawCommon_b86b1483_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(2404);
/* harmony import */ var dayjs__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(44657);
/* harmony import */ var dompurify__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(34644);
...
const autoWrap = () => {
  ...
  return (0,_mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.c)().sequence.wrap;
};
...
const parseMessage = function(str) {
  ...
  _mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.l.debug("parseMessage:", message);
  return message;
};
const parseBoxData = function(str) {
  ...
  return {
    color,
    text: title !== void 0 ? (0,_mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.d)(title.replace(/^:?(?:no)?wrap:/, ""), (0,_mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.c)()) : void 0,
...
const addLinks = function(actorId, text) {
  ...
  try {
    let sanitizedText = (0,_mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.d)(text.text, (0,_mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.c)());
    sanitizedText = sanitizedText.replace(/&amp;/g, "&");
    sanitizedText = sanitizedText.replace(/&equals;/g, "=");
    const links = JSON.parse(sanitizedText);
    insertLinks(actor, links);
  } catch (e) {
    _mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.l.error("error while parsing actor link text", e);
  }
};
...
const addProperties = function(actorId, text) {
  ...
  try {
    ...
    _mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.l.error("error while parsing actor properties text", e);
  }
};
...
const addDetails = function(actorId, text) {
  ...
  try {
    ...
    _mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.l.error("error while parsing actor details text", e);
  }
};
  ...
  if (Array.isArray(param)) {
    ...
    switch (param.type) {
      ...
      case "altEnd":
        ...
        break;
      case "setAccTitle":
        (0,_mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.s)(param.text);
        break;
      case "parStart":
...
const db = {
  ...
  getConfig: () => (0,_mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.c)().sequence,
  clear,
  parseMessage,
  parseBoxData,
  LINETYPE,
...
const drawRect = function(elem, rectData) {
  return (0,_svgDrawCommon_b86b1483_js__WEBPACK_IMPORTED_MODULE_3__.d)(elem, rectData);
};
const drawPopup = function(elem, actor, minMenuWidth, textAttrs, forceMenus) {
  ...
  if (links != null) {
    ...
    for (let key in links) {
      ...
      var sanitizedLink = (0,_braintree_sanitize_url__WEBPACK_IMPORTED_MODULE_2__/* .sanitizeUrl */ .Jf)(links[key]);
...
const drawKatex = async function(elem, textData, msgModel = null) {
  ...
  const linesSanitized = await (0,_mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.r)(textData.text, (0,_mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.F)());
...
const drawText = function(elem, textData) {
  ...
  let textHeight = 0;
  const lines = textData.text.split(_mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.e.lineBreakRegex);
  const [_textFontSize, _textFontSizePx] = (0,_mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.D)(textData.fontSize);
  let textElems = [];
  let dy = 0;
  ...
  for (let [i, line] of lines.entries()) {
    ...
    const text = line || _mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.Z;
    if (textData.tspan) {
...
const drawActorTypeParticipant = async function(elem, actor, conf2, isFooter) {
  ...
  const rect = (0,_svgDrawCommon_b86b1483_js__WEBPACK_IMPORTED_MODULE_3__.g)();
  var cssclass = "actor";
  ...
  if (actor.properties != null && actor.properties["icon"]) {
    ...
    if (iconSrc.charAt(0) === "@") {
      (0,_svgDrawCommon_b86b1483_js__WEBPACK_IMPORTED_MODULE_3__.b)(g, rect.x + rect.width - 20, rect.y + 10, iconSrc.substr(1));
    } else {
      (0,_svgDrawCommon_b86b1483_js__WEBPACK_IMPORTED_MODULE_3__.c)(g, rect.x + rect.width - 20, rect.y + 10, iconSrc);
    }
  }
  await _drawTextCandidateFunc(conf2, (0,_mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.G)(actor.description))(
    actor.description,
    g,
    rect.x,
    rect.y,
...
const drawLoop = async function(elem, loopModel, labelText, conf2) {
  ...
  let txt = (0,_svgDrawCommon_b86b1483_js__WEBPACK_IMPORTED_MODULE_3__.e)();
  txt.text = labelText;
  ...
  txt.fontWeight = fontWeight;
  txt.wrap = true;
  let textElem = (0,_mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.G)(txt.text) ? await drawKatex(g, txt, loopModel) : drawText(g, txt);
  if (loopModel.sectionTitles !== void 0) {
    for (const [idx, item] of Object.entries(loopModel.sectionTitles)) {
      if (item.message) {
        ...
        if ((0,_mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.G)(txt.text)) {
...
const drawBackgroundRect = function(elem, bounds2) {
  (0,_svgDrawCommon_b86b1483_js__WEBPACK_IMPORTED_MODULE_3__.a)(elem, bounds2);
};
...
const _drawTextCandidateFunc = function() {
  ...
  function byTspan(content, g, x, y, width, height, textAttrs, conf2) {
    ...
    const [_actorFontSize, _actorFontSizePx] = (0,_mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.D)(actorFontSize);
    const lines = content.split(_mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.e.lineBreakRegex);
  ...
  async function byKatex(content, g, x, y, width, height, textAttrs, conf2) {
    const dim = await (0,_mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.H)(content, (0,_mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.F)());
    const s = g.append("switch");
    ...
    text.append("div").style("text-align", "center").style("vertical-align", "middle").html(await (0,_mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.r)(content, (0,_mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.F)()));
    byTspan(content, s, x, y, width, height, textAttrs, conf2);
    _setTextAttrs(text, textAttrs);
  }
...
const svgDraw = {
  ...
  getNoteRect,
  fixLifeLineHeights,
  sanitizeUrl: _braintree_sanitize_url__WEBPACK_IMPORTED_MODULE_2__/* .sanitizeUrl */ .Jf
};
let conf = {};
const bounds = {
  data: {
  ...
  init: function() {
    ...
    this.verticalPos = 0;
    setConf((0,_mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.c)());
  },
  ...
  insert: function(startx, starty, stopx, stopy) {
    const _startx = _mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.e.getMin(startx, stopx);
    const _stopx = _mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.e.getMax(startx, stopx);
    const _starty = _mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.e.getMin(starty, stopy);
    const _stopy = _mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.e.getMax(starty, stopy);
  ...
  bumpVerticalPos: function(bump) {
    ...
    this.data.stopy = _mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.e.getMax(this.data.stopy, this.verticalPos);
  },
...
const drawNote = async function(elem, noteModel) {
  ...
  const textObj = (0,_svgDrawCommon_b86b1483_js__WEBPACK_IMPORTED_MODULE_3__.e)();
  ...
  const textElem = (0,_mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.G)(textObj.text) ? await drawKatex(g, textObj) : drawText(g, textObj);
...
async function boundMessage(_diagram, msgModel) {
  ...
  const lines = _mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.e.splitBreaks(message).length;
  const isKatexMsg = (0,_mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.G)(message);
  const textDims = isKatexMsg ? await (0,_mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.H)(message, (0,_mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.c)()) : _mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.u.calculateTextDimensions(message, messageFont(conf));
  if (!isKatexMsg) {
  ...
  if (startx === stopx) {
    ...
    totalOffset += 30;
    const dx = _mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.e.getMax(textWidth / 2, conf.width / 2);
    bounds.insert(
      startx - dx,
...
const drawMessage = async function(diagram2, msgModel, lineStartY, diagObj) {
  ...
  const textDims = _mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.u.calculateTextDimensions(message, messageFont(conf));
  const textObj = (0,_svgDrawCommon_b86b1483_js__WEBPACK_IMPORTED_MODULE_3__.e)();
  textObj.x = startx;
  textObj.y = starty + 10;
  ...
  textObj.tspan = false;
  (0,_mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.G)(textObj.text) ? await drawKatex(diagram2, textObj, { startx, stopx, starty: lineStartY }) : drawText(diagram2, textObj);
  const textWidth = textDims.width;
  let line;
  if (startx === stopx) {
    if (conf.rightAngles) {
      line = diagram2.append("path").attr(
        "d",
        `M  ${startx},${lineStartY} H ${startx + _mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.e.getMax(conf.width / 2, textWidth / 2)} V ${lineStartY + 25} H ${startx}`
      );
    } else {
      line = diagram2.append("path").attr(
        "d",
...
const addActorRenderingData = async function(diagram2, actors, createdActors, actorKeys, verticalPos, messages, isFooter) {
  ...
  for (const actorKey of actorKeys) {
    ...
    actor.height = _mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.e.getMax(actor.height || conf.height, conf.height);
    actor.margin = actor.margin || conf.actorMargin;
    maxHeight = _mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.e.getMax(maxHeight, actor.height);
...
const drawActors = async function(diagram2, actors, actorKeys, isFooter) {
  if (!isFooter) {
    ...
    for (const actorKey of actorKeys) {
      ...
      maxHeight = _mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.e.getMax(maxHeight, height);
    }
...
const setConf = function(cnf) {
  (0,_mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.f)(conf, cnf);
  if (cnf.fontFamily) {
...
const activationBounds = function(actor, actors) {
  ...
  const left = activations.reduce(function(acc, activation) {
    return _mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.e.getMin(acc, activation.startx);
  }, actorObj.x + actorObj.width / 2 - 1);
  const right = activations.reduce(function(acc, activation) {
    return _mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.e.getMax(acc, activation.stopx);
  }, actorObj.x + actorObj.width / 2 + 1);
  return [left, right];
};
function adjustLoopHeightForWrap(loopWidths, msg, preMargin, postMargin, addLoopFn) {
  ...
  if (msg.id && msg.message && loopWidths[msg.id]) {
    ...
    msg.message = _mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.u.wrapLabel(`[${msg.message}]`, loopWidth - 2 * conf.wrapPadding, textConf);
    msg.width = loopWidth;
    msg.wrap = true;
    const textDims = _mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.u.calculateTextDimensions(msg.message, textConf);
    const totalOffset = _mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.e.getMax(textDims.height, conf.labelBoxHeight);
    heightAdjust = postMargin + totalOffset;
    _mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.l.debug(`${totalOffset} - ${msg.message}`);
  }
  addLoopFn(msg);
...
const draw = async function(_text, id, _version, diagObj) {
  const { securityLevel, sequence } = (0,_mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.c)();
  conf = sequence;
  let sandboxElement;
  ...
  bounds.init();
  _mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.l.debug(diagObj.db);
  const diagram2 = securityLevel === "sandbox" ? root.select(`[id="${id}"]`) : (0,d3__WEBPACK_IMPORTED_MODULE_1__/* .select */ .Ltv)(`[id="${id}"]`);
    ...
    switch (msg.type) {
      ...
      default:
        try {
          ...
          _mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.l.error("error while drawing message", e);
        }
    }
    if ([
  ...
  _mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.l.debug("createdActors", createdActors);
  _mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.l.debug("destroyedActors", destroyedActors);
  ...
  (0,_mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.i)(diagram2, height, width, conf.useMaxWidth);
  const extraVertForTitle = title ? 40 : 0;
  diagram2.attr(
    "viewBox",
    box.startx - conf.diagramMarginX + " -" + (conf.diagramMarginY + extraVertForTitle) + " " + width + " " + (height + extraVertForTitle)
  );
  _mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.l.debug(`models:`, bounds.models);
};
async function getMaxMessageWidthPerActor(actors, messages, diagObj) {
  ...
  for (const msg of messages) {
    if (actors[msg.to] && actors[msg.from]) {
      ...
      const wrappedMessage = msg.wrap ? _mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.u.wrapLabel(msg.message, conf.width - 2 * conf.wrapPadding, textFont) : msg.message;
      const messageDimensions = (0,_mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.G)(wrappedMessage) ? await (0,_mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.H)(msg.message, (0,_mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.c)()) : _mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.u.calculateTextDimensions(wrappedMessage, textFont);
      const messageWidth = messageDimensions.width + 2 * conf.wrapPadding;
      if (isMessage && msg.from === actor.nextActor) {
        maxMessageWidthPerActor[msg.to] = _mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.e.getMax(
          maxMessageWidthPerActor[msg.to] || 0,
          messageWidth
        );
      } else if (isMessage && msg.from === actor.prevActor) {
        maxMessageWidthPerActor[msg.from] = _mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.e.getMax(
        ...
        maxMessageWidthPerActor[actor.prevActor] = _mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.e.getMax(
  ...
  _mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.l.debug("maxMessageWidthPerActor:", maxMessageWidthPerActor);
...
const getRequiredPopupWidth = function(actor) {
  ...
  for (const key in actor.links) {
    const labelDimensions = _mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.u.calculateTextDimensions(key, textFont);
...
async function calculateActorMargins(actors, actorToMessageWidth, boxes) {
  ...
  for (const prop of Object.keys(actors)) {
    ...
    if (actor.wrap) {
      actor.description = _mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.u.wrapLabel(
        actor.description,
        conf.width - 2 * conf.wrapPadding,
        actorFont(conf)
      );
    }
    const actDims = (0,_mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.G)(actor.description) ? await (0,_mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.H)(actor.description, (0,_mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.c)()) : _mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.u.calculateTextDimensions(actor.description, actorFont(conf));
    actor.width = actor.wrap ? conf.width : _mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.e.getMax(conf.width, actDims.width + 2 * conf.wrapPadding);
    actor.height = actor.wrap ? _mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.e.getMax(actDims.height, conf.height) : conf.height;
    maxHeight = _mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.e.getMax(maxHeight, actor.height);
  }
  for (const actorKey in actorToMessageWidth) {
    ...
    if (!nextActor) {
      ...
      actor.margin = _mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.e.getMax(actorWidth2, conf.actorMargin);
      continue;
    }
    const messageWidth = actorToMessageWidth[actorKey];
    const actorWidth = messageWidth + conf.actorMargin - actor.width / 2 - nextActor.width / 2;
    actor.margin = _mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.e.getMax(actorWidth, conf.actorMargin);
  }
  let maxBoxHeight = 0;
  boxes.forEach((box) => {
    ...
    if (box.wrap) {
      box.name = _mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.u.wrapLabel(box.name, totalWidth - 2 * conf.wrapPadding, textFont);
    }
    const boxMsgDimensions = _mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.u.calculateTextDimensions(box.name, textFont);
    maxBoxHeight = _mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.e.getMax(boxMsgDimensions.height, maxBoxHeight);
    const minWidth = _mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.e.getMax(totalWidth, boxMsgDimensions.width + 2 * conf.wrapPadding);
  ...
  return _mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.e.getMax(maxHeight, conf.height);
}
const buildNoteModel = async function(msg, actors, diagObj) {
  const startx = actors[msg.from].x;
  const stopx = actors[msg.to].x;
  const shouldWrap = msg.wrap && msg.message;
  let textDimensions = (0,_mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.G)(msg.message) ? await (0,_mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.H)(msg.message, (0,_mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.c)()) : _mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.u.calculateTextDimensions(
    shouldWrap ? _mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.u.wrapLabel(msg.message, conf.width, noteFont(conf)) : msg.message,
    noteFont(conf)
  );
  const noteModel = {
    width: shouldWrap ? conf.width : _mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.e.getMax(conf.width, textDimensions.width + 2 * conf.noteMargin),
    height: 0,
  ...
  if (msg.placement === diagObj.db.PLACEMENT.RIGHTOF) {
    noteModel.width = shouldWrap ? _mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.e.getMax(conf.width, textDimensions.width) : _mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.e.getMax(
      actors[msg.from].width / 2 + actors[msg.to].width / 2,
      textDimensions.width + 2 * conf.noteMargin
    );
    noteModel.startx = startx + (actors[msg.from].width + conf.actorMargin) / 2;
  } else if (msg.placement === diagObj.db.PLACEMENT.LEFTOF) {
    noteModel.width = shouldWrap ? _mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.e.getMax(conf.width, textDimensions.width + 2 * conf.noteMargin) : _mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.e.getMax(
      actors[msg.from].width / 2 + actors[msg.to].width / 2,
      textDimensions.width + 2 * conf.noteMargin
    );
    noteModel.startx = startx - noteModel.width + (actors[msg.from].width - conf.actorMargin) / 2;
  } else if (msg.to === msg.from) {
    textDimensions = _mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.u.calculateTextDimensions(
      shouldWrap ? _mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.u.wrapLabel(
        msg.message,
        _mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.e.getMax(conf.width, actors[msg.from].width),
        noteFont(conf)
      ) : msg.message,
      noteFont(conf)
    );
    noteModel.width = shouldWrap ? _mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.e.getMax(conf.width, actors[msg.from].width) : _mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.e.getMax(
  ...
  if (shouldWrap) {
    noteModel.message = _mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.u.wrapLabel(
      msg.message,
...
const buildMessageModel = function(msg, actors, diagObj) {
  ...
  if (msg.wrap && msg.message) {
    msg.message = _mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.u.wrapLabel(
      msg.message,
      _mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.e.getMax(boundedWidth + 2 * conf.wrapPadding, conf.width),
      messageFont(conf)
    );
  }
  const msgDims = _mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.u.calculateTextDimensions(msg.message, messageFont(conf));
  return {
    width: _mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.e.getMax(
...
const calculateLoopBounds = async function(messages, actors, _maxWidthPerActor, diagObj) {
  ...
  for (const msg of messages) {
    msg.id = _mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.u.random({ length: 10 });
    switch (msg.type) {
      case diagObj.db.LINETYPE.LOOP_START:
      case diagObj.db.LINETYPE.ALT_START:
      case diagObj.db.LINETYPE.OPT_START:
    ...
    if (isNote) {
      ...
      stack.forEach((stk) => {
        current = stk;
        current.from = _mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.e.getMin(current.from, noteModel.startx);
        current.to = _mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.e.getMax(current.to, noteModel.startx + noteModel.width);
        current.width = _mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.e.getMax(current.width, Math.abs(current.from - current.to)) - conf.labelBoxWidth;
      });
    } else {
      ...
      if (msgModel.startx && msgModel.stopx && stack.length > 0) {
        stack.forEach((stk) => {
          ...
          if (msgModel.startx === msgModel.stopx) {
            ...
            current.from = _mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.e.getMin(
              from.x - msgModel.width / 2,
              from.x - from.width / 2,
              current.from
            );
            current.to = _mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.e.getMax(
              to.x + msgModel.width / 2,
              to.x + from.width / 2,
              current.to
            );
            current.width = _mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.e.getMax(current.width, Math.abs(current.to - current.from)) - conf.labelBoxWidth;
          } else {
            current.from = _mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.e.getMin(msgModel.startx, current.from);
            current.to = _mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.e.getMax(msgModel.stopx, current.to);
            current.width = _mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.e.getMax(current.width, msgModel.width) - conf.labelBoxWidth;
          }
        });
      }
    }
  ...
  bounds.activations = [];
  _mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.l.debug("Loop type widths:", loops);
  return loops;
};
const renderer = {
  bounds,
...
/* harmony export */ });
/* harmony import */ var _braintree_sanitize_url__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(48488);
