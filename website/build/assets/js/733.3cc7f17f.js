...
/* harmony import */ var _createText_1719965b_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(68241);
/* harmony import */ var d3__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(99564);
/* harmony import */ var dayjs__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(44657);
/* harmony import */ var _braintree_sanitize_url__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(48488);
...
class TextDimensionCalculatorWithFont {
  ...
  getMaxDimension(texts, fontSize) {
    ...
    for (const t of texts) {
      const bbox = (0,_createText_1719965b_js__WEBPACK_IMPORTED_MODULE_1__.c)(elem, 1, t);
...
class BandAxis extends BaseAxis {
  constructor(axisConfig, axisThemeConfig, categories, title, textDimensionCalculator) {
    ...
    this.scale = (0,d3__WEBPACK_IMPORTED_MODULE_2__/* .scaleBand */ .WH)().domain(this.categories).range(this.getRange());
  }
  setRange(range) {
    super.setRange(range);
  }
  recalculateScale() {
    this.scale = (0,d3__WEBPACK_IMPORTED_MODULE_2__/* .scaleBand */ .WH)().domain(this.categories).range(this.getRange()).paddingInner(1).paddingOuter(0).align(0.5);
    _mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.l.trace("BandAxis axis final categories, range: ", this.categories, this.getRange());
  }
  getTickValues() {
...
class LinearAxis extends BaseAxis {
  constructor(axisConfig, axisThemeConfig, domain, title, textDimensionCalculator) {
    super(axisConfig, title, textDimensionCalculator, axisThemeConfig);
    this.domain = domain;
    this.scale = (0,d3__WEBPACK_IMPORTED_MODULE_2__/* .scaleLinear */ .m4Y)().domain(this.domain).range(this.getRange());
  }
  getTickValues() {
  ...
  recalculateScale() {
    ...
    this.scale = (0,d3__WEBPACK_IMPORTED_MODULE_2__/* .scaleLinear */ .m4Y)().domain(domain).range(this.getRange());
  }
  getScaleValue(value) {
...
class LinePlot {
  ...
  getDrawableElement() {
    ...
    if (this.orientation === "horizontal") {
      path = (0,d3__WEBPACK_IMPORTED_MODULE_2__/* .line */ .n8j)().y((d) => d[0]).x((d) => d[1])(finalData);
    } else {
      path = (0,d3__WEBPACK_IMPORTED_MODULE_2__/* .line */ .n8j)().x((d) => d[0]).y((d) => d[1])(finalData);
    }
    if (!path) {
      return [];
    }
...
function getChartDefaultThemeConfig() {
  ...
  const config = (0,_mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.F)();
  return (0,_mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.C)(defaultThemeVariables.xyChart, config.themeVariables.xyChart);
}
function getChartDefaultConfig() {
  const config = (0,_mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.F)();
  return (0,_mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.C)(
    _mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.B.xyChart,
    config.xyChart
  );
}
...
function getDrawableElem() {
  ...
  xyChartData.title = (0,_mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.t)();
...
const draw = (txt, id, _version, diagObj) => {
  ...
  _mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.l.debug("Rendering xychart chart\n" + txt);
  const svg = (0,_mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.A)(id);
  ...
  (0,_mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.i)(svg, chartConfig.height, chartConfig.width, true);
