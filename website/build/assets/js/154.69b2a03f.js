...
/* harmony import */ var dayjs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(44657);
/* harmony import */ var dayjs_plugin_isoWeek_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(73849);
/* harmony import */ var dayjs_plugin_customParseFormat_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(53677);
/* harmony import */ var dayjs_plugin_advancedFormat_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(45119);
/* harmony import */ var _mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(70872);
...
const getStartDate = function(prevTime, dateFormat2, str) {
  ...
  if (mDate.isValid()) {
    ...
    _mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_5__.l.debug("Invalid date:" + str);
    _mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_5__.l.debug("With date format:" + dateFormat2.trim());
...
const setLink = function(ids, _linkStr) {
  ...
  if ((0,_mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_5__.c)().securityLevel !== "loose") {
...
const setClickFun = function(id, functionName, functionArgs) {
  ...
  if (rawTask !== void 0) {
    pushFun(id, () => {
      _mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_5__.u.runFunc(functionName, ...argList);
    });
  }
};
...
const ganttDb = {
  getConfig: () => (0,_mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_5__.c)().gantt,
  clear,
  setDateFormat,
  getDateFormat,
...
const setConf = function() {
  _mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_5__.l.debug("Something is calling, setConf, remove the call");
};
const mapWeekdayToTimeFunction = {
  monday: d3__WEBPACK_IMPORTED_MODULE_6__/* .timeMonday */ .ABi,
  tuesday: d3__WEBPACK_IMPORTED_MODULE_6__/* .timeTuesday */ .PGu,
  wednesday: d3__WEBPACK_IMPORTED_MODULE_6__/* .timeWednesday */ .GuW,
  thursday: d3__WEBPACK_IMPORTED_MODULE_6__/* .timeThursday */ .Mol,
  friday: d3__WEBPACK_IMPORTED_MODULE_6__/* .timeFriday */ .TUC,
  saturday: d3__WEBPACK_IMPORTED_MODULE_6__/* .timeSaturday */ .rGn,
  sunday: d3__WEBPACK_IMPORTED_MODULE_6__/* .timeSunday */ .YPH
};
...
const draw = function(text, id, version, diagObj) {
  const conf = (0,_mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_5__.c)().gantt;
  const securityLevel = (0,_mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_5__.c)().securityLevel;
  let sandboxElement;
  ...
  const timeScale = (0,d3__WEBPACK_IMPORTED_MODULE_6__/* .scaleTime */ .w7C)().domain([
    (0,d3__WEBPACK_IMPORTED_MODULE_6__/* .min */ .jkA)(taskArray, function(d) {
      return d.startTime;
    }),
    (0,d3__WEBPACK_IMPORTED_MODULE_6__/* .max */ .T9B)(taskArray, function(d) {
      return d.endTime;
    })
  ...
  (0,_mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_5__.i)(svg, h, w, conf.useMaxWidth);
  ...
  function makeGantt(tasks2, pageWidth, pageHeight) {
    ...
    const colorScale = (0,d3__WEBPACK_IMPORTED_MODULE_6__/* .scaleLinear */ .m4Y)().domain([0, categories.length]).range(["#00B9FA", "#F95002"]).interpolate(d3__WEBPACK_IMPORTED_MODULE_6__/* .interpolateHcl */ .bEH);
    drawExcludeDays(
      gap,
      topPadding,
      leftPadding,
  ...
  function drawRects(theArray, theGap, theTopPad, theSidePad, theBarHeight, theColorScale, w2) {
    ...
    const securityLevel2 = (0,_mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_5__.c)().securityLevel;
    if (securityLevel2 === "sandbox") {
      let sandboxElement2;
      sandboxElement2 = (0,d3__WEBPACK_IMPORTED_MODULE_6__/* .select */ .Ltv)("#i" + id);
  ...
  function drawExcludeDays(theGap, theTopPad, theSidePad, w2, h2, tasks2, excludes2, includes2) {
    ...
    if (dayjs__WEBPACK_IMPORTED_MODULE_1__(maxTime).diff(dayjs__WEBPACK_IMPORTED_MODULE_1__(minTime), "year") > 5) {
      _mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_5__.l.warn(
  ...
  function makeGrid(theSidePad, theTopPad, w2, h2) {
    let bottomXAxis = (0,d3__WEBPACK_IMPORTED_MODULE_6__/* .axisBottom */ .l78)(timeScale).tickSize(-h2 + theTopPad + conf.gridLineStartPadding).tickFormat((0,d3__WEBPACK_IMPORTED_MODULE_6__/* .timeFormat */ .DCK)(diagObj.db.getAxisFormat() || conf.axisFormat || "%Y-%m-%d"));
    ...
    if (resultTickInterval !== null) {
      ...
      switch (interval) {
        case "millisecond":
          bottomXAxis.ticks(d3__WEBPACK_IMPORTED_MODULE_6__/* .timeMillisecond */ .t6C.every(every));
          break;
        case "second":
          bottomXAxis.ticks(d3__WEBPACK_IMPORTED_MODULE_6__/* .timeSecond */ .ucG.every(every));
          break;
        case "minute":
          bottomXAxis.ticks(d3__WEBPACK_IMPORTED_MODULE_6__/* .timeMinute */ .wXd.every(every));
          break;
        case "hour":
          bottomXAxis.ticks(d3__WEBPACK_IMPORTED_MODULE_6__/* .timeHour */ .Agd.every(every));
          break;
        case "day":
          bottomXAxis.ticks(d3__WEBPACK_IMPORTED_MODULE_6__/* .timeDay */ .UAC.every(every));
          break;
        case "week":
          bottomXAxis.ticks(mapWeekdayToTimeFunction[weekday2].every(every));
          break;
        case "month":
          bottomXAxis.ticks(d3__WEBPACK_IMPORTED_MODULE_6__/* .timeMonth */ .Ui6.every(every));
          break;
      }
    }
    svg.append("g").attr("class", "grid").attr("transform", "translate(" + theSidePad + ", " + (h2 - 50) + ")").call(bottomXAxis).selectAll("text").style("text-anchor", "middle").attr("fill", "#000").attr("stroke", "none").attr("font-size", 10).attr("dy", "1em");
    if (diagObj.db.topAxisEnabled() || conf.topAxis) {
      let topXAxis = (0,d3__WEBPACK_IMPORTED_MODULE_6__/* .axisTop */ .tlR)(timeScale).tickSize(-h2 + theTopPad + conf.gridLineStartPadding).tickFormat((0,d3__WEBPACK_IMPORTED_MODULE_6__/* .timeFormat */ .DCK)(diagObj.db.getAxisFormat() || conf.axisFormat || "%Y-%m-%d"));
      if (resultTickInterval !== null) {
        const every = resultTickInterval[1];
        const interval = resultTickInterval[2];
        const weekday2 = diagObj.db.getWeekday() || conf.weekday;
        switch (interval) {
          case "millisecond":
            topXAxis.ticks(d3__WEBPACK_IMPORTED_MODULE_6__/* .timeMillisecond */ .t6C.every(every));
            break;
          case "second":
            topXAxis.ticks(d3__WEBPACK_IMPORTED_MODULE_6__/* .timeSecond */ .ucG.every(every));
            break;
          case "minute":
            topXAxis.ticks(d3__WEBPACK_IMPORTED_MODULE_6__/* .timeMinute */ .wXd.every(every));
            break;
          case "hour":
            topXAxis.ticks(d3__WEBPACK_IMPORTED_MODULE_6__/* .timeHour */ .Agd.every(every));
            break;
          case "day":
            topXAxis.ticks(d3__WEBPACK_IMPORTED_MODULE_6__/* .timeDay */ .UAC.every(every));
            break;
          case "week":
            topXAxis.ticks(mapWeekdayToTimeFunction[weekday2].every(every));
            break;
          case "month":
            topXAxis.ticks(d3__WEBPACK_IMPORTED_MODULE_6__/* .timeMonth */ .Ui6.every(every));
            break;
        }
      }
  ...
  function vertLabels(theGap, theTopPad) {
    ...
    svg.append("g").selectAll("text").data(numOccurrences).enter().append(function(d) {
      const rows = d[0].split(_mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_5__.e.lineBreakRegex);
