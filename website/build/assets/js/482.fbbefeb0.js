...
/* harmony import */ var dayjs__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(44657);
/* harmony import */ var _braintree_sanitize_url__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(48488);
/* harmony import */ var dompurify__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(34644);
...
let mainBranchName = (0,_mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.c)().gitGraph.mainBranchName;
let mainBranchOrder = (0,_mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.c)().gitGraph.mainBranchOrder;
let commits = {};
let head = null;
let branchesConfig = {};
...
let seq = 0;
function getId() {
  return (0,_mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.y)({ length: 7 });
}
...
const setOptions = function(rawOptString) {
  _mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.l.debug("options str", rawOptString);
  rawOptString = rawOptString && rawOptString.trim();
  rawOptString = rawOptString || "{}";
  try {
    options = JSON.parse(rawOptString);
  } catch (e) {
    _mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.l.error("error while parsing gitGraph options", e.message);
  }
};
...
const commit = function(msg, id, type, tag) {
  _mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.l.debug("Entering commit:", msg, id, type, tag);
  id = _mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.e.sanitizeText(id, (0,_mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.c)());
  msg = _mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.e.sanitizeText(msg, (0,_mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.c)());
  tag = _mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.e.sanitizeText(tag, (0,_mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.c)());
  const commit2 = {
    id: id ? id : seq + "-" + getId(),
    message: msg,
    seq: seq++,
  ...
  _mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.l.debug("in pushCommit " + commit2.id);
};
const branch = function(name, order) {
  name = _mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.e.sanitizeText(name, (0,_mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.c)());
  if (branches[name] === void 0) {
    branches[name] = head != null ? head.id : null;
    branchesConfig[name] = { name, order: order ? parseInt(order, 10) : null };
    checkout(name);
    _mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.l.debug("in createBranch");
  } else {
    let error = new Error(
...
const merge = function(otherBranch, custom_id, override_type, custom_tag) {
  otherBranch = _mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.e.sanitizeText(otherBranch, (0,_mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.c)());
  custom_id = _mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.e.sanitizeText(custom_id, (0,_mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.c)());
  ...
  commits[commit2.id] = commit2;
  branches[curBranch] = commit2.id;
  _mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.l.debug(branches);
  _mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.l.debug("in mergeBranch");
};
const cherryPick = function(sourceId, targetId, tag, parentCommitId) {
  _mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.l.debug("Entering cherryPick:", sourceId, targetId, tag);
  sourceId = _mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.e.sanitizeText(sourceId, (0,_mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.c)());
  targetId = _mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.e.sanitizeText(targetId, (0,_mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.c)());
  tag = _mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.e.sanitizeText(tag, (0,_mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.c)());
  parentCommitId = _mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.e.sanitizeText(parentCommitId, (0,_mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.c)());
  ...
  if (!targetId || commits[targetId] === void 0) {
    ...
    branches[curBranch] = commit2.id;
    _mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.l.debug(branches);
    _mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.l.debug("in cherryPick");
  }
};
const checkout = function(branch2) {
  branch2 = _mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.e.sanitizeText(branch2, (0,_mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.c)());
...
function prettyPrintCommitHistory(commitArr) {
  ...
  _mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.l.debug(label.join(" "));
...
const prettyPrint = function() {
  _mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.l.debug(commits);
...
const clear$1 = function() {
  commits = {};
  head = null;
  let mainBranch = (0,_mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.c)().gitGraph.mainBranchName;
  let mainBranchOrder2 = (0,_mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.c)().gitGraph.mainBranchOrder;
  branches = {};
...
const getCommitsArray = function() {
  ...
  commitArr.forEach(function(o) {
    _mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.l.debug(o.id);
  });
...
const gitGraphDb = {
  getConfig: () => (0,_mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.c)().gitGraph,
  setDirection,
  setOptions,
  getOptions,
  commit,
...
const drawCommits = (svg, commits2, modifyGraph) => {
  const gitGraphConfig = (0,_mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.c)().gitGraph;
...
const draw = function(txt, id, ver, diagObj) {
  clear();
  const conf = (0,_mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.c)();
  const gitGraphConfig = conf.gitGraph;
  _mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.l.debug("in gitgraph renderer", txt + "\n", "id:", id, ver);
  allCommitsDict = diagObj.db.getCommits();
  const branches2 = diagObj.db.getBranchesAsObjArray();
  dir = diagObj.db.getDirection();
  const diagram2 = (0,d3__WEBPACK_IMPORTED_MODULE_1__/* .select */ .Ltv)(`[id="${id}"]`);
  let pos = 0;
  branches2.forEach((branch2, index) => {
  ...
  _mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.u.insertTitle(
    diagram2,
    "gitTitleText",
    gitGraphConfig.titleTopMargin,
    diagObj.db.getDiagramTitle()
  );
  (0,_mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_0__.z)(
    void 0,
    diagram2,
