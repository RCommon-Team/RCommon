...
const drawEdge = function(elem, path, relation, conf, diagObj) {
  ...
  let labelPosition = _mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_4__.u.calcLabelPosition(path.points);
  x = labelPosition.x;
  y = labelPosition.y;
  let p1_card_x, p1_card_y;
  let p2_card_x, p2_card_y;
  if (l % 2 !== 0 && l > 1) {
    let cardinality_1_point = _mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_4__.u.calcCardinalityPosition(
      relation.relation.type1 !== "none",
      path.points,
      path.points[0]
    );
    let cardinality_2_point = _mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_4__.u.calcCardinalityPosition(
      relation.relation.type2 !== "none",
      path.points,
      path.points[l - 1]
    );
    _mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_4__.l.debug("cardinality_1_point " + JSON.stringify(cardinality_1_point));
    _mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_4__.l.debug("cardinality_2_point " + JSON.stringify(cardinality_2_point));
  ...
  _mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_4__.l.info("Rendering relation " + JSON.stringify(relation));
...
const drawClass = function(elem, classDef, conf, diagObj) {
  _mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_4__.l.debug("Rendering class ", classDef, conf);
...
const getClassTitleString = function(classDef) {
  ...
  if (classDef.type) {
    classTitleString += "<" + (0,_mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_4__.x)(classDef.type) + ">";
  }
  return classTitleString;
};
const drawNote = function(elem, note, conf, diagObj) {
  _mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_4__.l.debug("Rendering note ", note, conf);
  const id = note.id;
  const noteInfo = {
    id,
    text: note.text,
  ...
  lines.forEach(function(line2) {
    _mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_4__.l.debug(`Adding line: ${line2}`);
...
const draw = function(text, id, _version, diagObj) {
  const conf = (0,_mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_4__.c)().class;
  idCache = {};
  _mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_4__.l.info("Rendering diagram " + text);
  ...
  for (const key of keys) {
    ...
    _mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_4__.l.info("Org height: " + node.height);
  }
  ...
  notes.forEach(function(note) {
    _mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_4__.l.debug(`Adding note: ${JSON.stringify(note)}`);
  ...
  g.nodes().forEach(function(v) {
    if (v !== void 0 && g.node(v) !== void 0) {
      _mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_4__.l.debug("Node " + v + ": " + JSON.stringify(g.node(v)));
  ...
  g.edges().forEach(function(e) {
    if (e !== void 0 && g.edge(e) !== void 0) {
      _mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_4__.l.debug("Edge " + e.v + " -> " + e.w + ": " + JSON.stringify(g.edge(e)));
  ...
  _mermaid_7ea9cbd6_js__WEBPACK_IMPORTED_MODULE_4__.l.debug(`viewBox ${vBox}`);
