...
[Contributing to Docs](/contributing.mdx) page that will walk you through the end-to-end contribution process from
...
It is your task to consider which of these types of documentation fits the user requirement most for the feature you are
documenting it. Maybe it's two or three, maybe it's all of them
...
We have a full write-up on the wiki about the [docs contribution process](/contributing.mdx#step-1-create-a-new-branch),
please check it out.

Importantly, the docs team is tasked with maintaining and uplifting the quality of the documentation with every single
pull request. Please also check out the [docs PR checklist](/checklist.mdx) with info about how you can ensure the
quality of your docs PR.
