...
{
    /// <summary>
    /// Implementation of <see cref="IContextState"/> that wraps a <see cref="IContextState"/> instance
    /// from a <see cref="IContextStateSelector"/>.
    /// </summary>
    public class ContextStateWrapper : IContextState
    {
        readonly IContextState _state;

        /// <summary>
        /// Default Constructor.
        /// Creates a new instance of the <see cref="ContextStateWrapper"/> class.
        /// </summary>
        /// <param name="selector">A <see cref="IContextStateSelector"/> instance used by the wrapper
        /// to obtain the underlying <see cref="IContextState"/> instance.</param>
        public ContextStateWrapper(IContextStateSelector selector)
        {
            _state = selector.Get();
        }
